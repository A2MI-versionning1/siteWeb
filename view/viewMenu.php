<div classe='menu'>
	...
	<div id='Menu'>
		<a href="presentation.php"><img src='static/images/gif/<?php echo $logomenu1 ?>'><font><?php echo $getTitre1 ?></font></a>
		<a href=""><img src='static/images/gif/<?php echo $logomenu2 ?>'><font><?php echo $getTitre2 ?></font></a>
			<ul>	
				<!-- Sous-menu de savoir faire -->
