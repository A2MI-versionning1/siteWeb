		...
		<br/>
			...
			<ul id='menu'>
				...
				<div id="presentation"><li><br/><a href='../presentation/presentation2.php'><img src="../images/gif/Pre.gif"   style="margin-left: 95px" onmouseover="this.src='../images/gif/Pre2.gif'" onmouseout="this.src='../images/gif/Pre.gif'" height='100px' width='100px'/></br><font color='white' style="margin-left: 105px">Présentation</font></a>
				</div>
				</li>
				...
				<li><br/><a href='../contacter/formulaireContact2.php'><img src="../images/gif/crea.gif"  style="margin-left: 77px" onmouseover="this.src='../images/gif/crea2.gif'" onmouseout="this.src='../images/gif/crea.gif'" height='100px' width='100px'/></br><font color='white' style="margin-left: 100px">Contact</font></a>
					...
					<ul>
						<div id="flyers"><li><a href='../contacter/formulaireContact2.php'><font size='4'>Formulaire contact</font></a></li></div>
