		...
		<br/>
			...
			<ul id='menu'>
				...
				<!--menu cartes de visite-->
				
				<li><br/><a href='../realisation/cartesRT.php'><img src="../images/plateforme/cv.png"  style="margin-left: 85px" onmouseover="this.src='../images/plateforme/cv2.png'" onmouseout="this.src='../images/plateforme/cv.png'" height='100px' width='100px'/></br><font color='white' style="margin-left: 80px">Cartes de visite</font></a>
				</li>
				...
				<li><br/><a href='../realisation/LogoRT.php'><img src="../images/plateforme/L.png"  style="margin-left: 78px" onmouseover="this.src='../images/plateforme/L2.png'" onmouseout="this.src='../images/plateforme/L.png'" height='100px' width='100px'/></br><font color='white' style="margin-left: 110px">Logo</font></a>
			</ul>
		</div>